...
df_antibiotics %>% 
  ...
  scale_y_log10() +
  geom_label_repel(aes(label = bacteria, fill = neomycin), color = "white", size = 2.75, box.padding = 0.25, point.padding = 1, segment.color = 'grey50') +
